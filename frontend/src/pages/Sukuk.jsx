      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 md:mb-12">
          ...
          <p className="text-sm md:text-base text-gray-400 max-w-3xl mx-auto">
            Understanding Islamic bonds (Sukuk) - their structures, Shariah
            compliance mechanisms, and real-world applications in global Islamic
            finance.
          </p>
        </div>
                ...
                >
                  ...
                  <div
                    className={`inline-flex items-center gap-2 text-xs px-3 py-1.5 rounded-lg border ${
                      riskColors[structure.risk_profile.split(" - ")[0]] ||
              ...
              <table className="w-full text-sm">
                <thead className="border-b border-gray-700">
                  <tr className="text-left">
                    ...
                    <th className="py-3 text-gray-400 font-medium hidden md:table-cell">
                      Size (USD)
                    </th>
                    <th className="py-3 text-gray-400 font-medium">Rate</th>
                    <th className="py-3 text-gray-400 font-medium hidden lg:table-cell">
                      Maturity
                    </th>
                  </tr>
                </thead>
            ...
            <div className="px-6 md:px-8 py-6 space-y-6">
              ...
              <div className="bg-emerald-900/10 border border-emerald-400/30 rounded-lg p-4 md:p-6">
                ...
                <p className="text-gray-300">
                  {selectedStructure.underlying_asset}
                </p>
              </div>
              ...
              <div className="bg-gold-900/10 border border-gold-400/30 rounded-lg p-4 md:p-6">
                ...
                <p className="text-gray-300 leading-relaxed">
                  {selectedStructure.shariah_basis}
                </p>
              </div>
